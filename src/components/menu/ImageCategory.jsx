    ...
    return (
        < >
            <div className='mainBtns' style={{ textAlign: 'center', justifyContent: 'space-between', alignItems: 'center', marginTop: '10px' }}>
                ...
                <button style={{ cursor: 'pointer', backgroundColor: 'blue', padding: '3px', marginLeft: '20px', borderRadius: '5px' }}>Dinner</button>
                <button style={{ cursor: 'pointer', backgroundColor: 'blue', padding: '3px', marginLeft: '20px', borderRadius: '5px' }}>Lunch</button>
